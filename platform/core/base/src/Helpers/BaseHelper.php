...
class BaseHelper
{
    ...
    public function getAdminMasterLayoutSupportTemplate(): string
    {
        return apply_filters('base_filter_admin_master_layout_support_template', 'core/base::layouts.chat_master');
    }
