<div class="product-loop__buttons">
    ...
    {{--  <div class="chat-button product-loop_button product-chat">
        <a class="chat product-loop_action" href="javascript:void(0)">
            <div class="product-loop_icon">
                <span class="svg-icon">
    ...
    @if (EcommerceHelper::isWishlistEnabled())
        <div class="wishlist-button product-wishlist-button product-loop_button">
            <a class="wishlist product-loop_action @if (!empty($wishlistIds) && in_array($product->id, $wishlistIds)) added-to-wishlist @endif"
                href="#" data-url="{{ route('public.ajax.add-to-wishlist', ['product_id' => $product->id]) }}"
                title="{{ __('Wishlist') }}">
    ...
    @if (EcommerceHelper::isCompareEnabled())
        <div class="compare-button product-compare-button product-loop_button">
            <a class="compare product-loop_action" href="#"
