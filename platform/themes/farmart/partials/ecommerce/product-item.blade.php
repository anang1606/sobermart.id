<div class="product-thumbnail">
    <a class="product-loop__link img-fluid-eq" href="{{ $product->url }}" tabindex="0">
        ...
        <div class="img-fluid-eq__wrap">
            <img class="lazyload product-thumbnail__img" src="{{ image_placeholder($product->image, 'small') }}"
            ...
            @else
                ...
                @else
                    @if ($product->front_sale_price !== $product->price)
                        <div class="featured ribbon" dir="ltr">
...
<div class="product-details position-relative">
    <div class="product-content-box">
        ...
        <span class="css-1kdc32b" style="text-transform: capitalize">
            <i class="icon icon-map-marker mr-1"></i>{{ $product->store->city }}
        </span>
        <span class="css-1kdc32b" style="text-transform: capitalize;justify-content: space-between">
            Terjual <span>{{ $product->terjual }}</span>
        </span>
