        ...
        <div class="container-xxxl">
            <div class="row gx-0 gx-md-4">
                <div class="col-md-12">
                    <div class="row">
                        <div
                            class="@if (is_plugin_active('ads') && $shortcode->ads) col-xxl-9 col-xl-8 col-md-8 @else col-md-12 @endif">
                            <div class="section-slides-wrapper my-3">
                                <div class="slide-body slick-slides-carousel" data-slick="{{ json_encode($slick) }}">
                                    @foreach ($sliders as $slider)
                                        <div class="slide-item slider-custom-ads">
                            ...
                            <div class="col-xxl-3 col-xl-4 col-md-4">
                                <div class="section-banner-wrapper my-3">
                                    <div class="banner-medium">
                                        <div class="banner-item__image slider-custom-ads-min">
                ...
                <div class="@if (is_plugin_active('ads') && $shortcode->ads) col-xxl-9 col-xl-8 col-md-8 @else col-md-12 @endif top-category__thumb">
                    @php
                        $path = Theme::getThemeNamespace() . '::partial.shortcodes.slider-categories-slider';
                    @endphp
                    @include('theme.farmart::partials.shortcodes.slider-categories-slider')
                </div>
            </div>
        </div>
    </div>
