...
<main class="ps-main">
        ...
        <div class="ps-sidebar">
            <div class="ps-sidebar__top">
                <div class="ps-block--user-wellcome">
                    ...
                    <div class="ps-block__action"><a href="{{ route('customer.logout') }}"><i
                                class="icon-exit"></i></a></div>
                </div>
    ...
    <div class="ps-main__wrapper" id="vendor-dashboard"
        style="padding:{{ $currentRouteName === 'marketplace.vendor.chats.index' ? '0 !important' : '' }}">
        @if ($currentRouteName !== 'marketplace.vendor.chats.index')
            <header class="header--dashboard">
                ...
                @if (auth('customer')->user()->store && auth('customer')->user()->store->id)
                    <div class="header__right">
                        <div class="me-4">
                            @include(MarketplaceHelper::viewPath('dashboard.partials.notif-order'))
                        </div>
