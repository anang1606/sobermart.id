            ...
            <aside class="catalog-primary-sidebar catalog-sidebar"
                ...
                <div class="catalog-sidebar--inner side-left">
                    ...
                    <div class="catalog-filter-sidebar-content px-3 px-md-0">
                        <form action="{{ URL::current() }}" data-action="{{ $store->url }}" method="GET"
                            id="products-filter-form">
                            <input type="hidden" name="sort-by" class="product-filter-item"
                                value="{{ request()->input('sort-by') }}">
                            <input type="hidden" name="layout" class="product-filter-item"
                                value="{{ request()->input('layout') }}">
                            <div class="css-198pnlw">
                                <h4 class="css-1nbp8ag-unf-heading">{{ __('Etalase Toko') }} ({{ count($etalase) - 1 }})
                                </h4>
                                @include(Theme::getThemeNamespace() . '::views.ecommerce.includes.etalase',
                                    compact('etalase', 'urlCurrent', 'isActive'))
                            </div>
                            {{--  <div class="widget-wrapper widget-product-categories">
                                <input type="hidden" name="categories[]"
                                    value="{{ Arr::get($categoriesRequest, 0, '') }}" class="product-filter-item">
                ...
                <div class="catalog-sidebar--inner side-left">
                    ...
                    <div class="catalog-filter-sidebar-content px-3 px-md-0">
                        <div class="widget-wrapper widget-contact-store">
                            ...
                            <form class="form-contact-store" action="{{ route('public.ajax.contact-seller') }}"
                                method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <textarea class="form-control" name="content" maxlength="5000" cols="25" rows="6"
                                        placeholder="{{ __('Type your message...') }}" required="required"></textarea>
                                </div>
                                <div class="d-grid">
                        ...
                        <form action="{{ URL::current() }}" method="GET" class="products-filter-form-vendor">
                            <div class="input-group">
                                <input type="text" class="form-control" name="q"
                                    ...
                                    form="products-filter-form" placeholder="{{ __('Search in this store...') }}">
