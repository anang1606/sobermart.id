...
<div class="container-xxxl mb-4">
    <div class="row">
        <div class="col-12">
                                ...
                                <div class="store-toolbar__view d-flex align-items-center">
                                    <div class="toolbar-view__icon">
                                        <a class="grid @if ($layout != 'list') active @endif" href="#"
                                            data-layout="grid" data-target=".store-listing-content"
                                        ...
                                        <a class="list @if ($layout == 'list') active @endif" href="#"
                                            data-layout="list" data-target=".store-listing-content"
                    ...
                    <div class="col-12 bg-light p-4 border">
                        <div class="store-search">
                            <input class="form-control" name="q"
                                value="{{ BaseHelper::stringify(request()->query('q')) }}" type="search"
                                placeholder="{{ __('Search store...') }}">
                        </div>
                        <div class="apply-filter row justify-content-end mt-2">
                            <div class="col-auto">
                                <button class="btn btn-primary px-4 py-2 border border-secondary"
            ...
            <div class="my-4">
                <div
                    class="row @if ($layout == 'list') row-cols-sm-2 row-cols-1 store-listing__list @else row-cols-md-6 row-cols-sm-2 row-cols-1 @endif store-listing-content">
                                ...
                                <div class="card store-card-wrapper h-100">
                                    <div class="card-header p-0 pt-3 pb-3 text-center">
                                        <a class="store-logo" href="{{ $store->url }}">
                                            <img class="lazyload" style="background-color: #fff; border-radius: 50%; width:40%; height:auto"
                                                data-src="{{ $store->logo_url }}" alt="{{ $store->name }}">
                                        </a>
                                    </div>
                                    ...
                                    <div class="card-footer store-footer bg-light border-0">
                                        <div class="px-2 border-top visit-store-wrapper">
                                            <a class="mt-2 btn btn-secondary" href="{{ $store->url }}"
