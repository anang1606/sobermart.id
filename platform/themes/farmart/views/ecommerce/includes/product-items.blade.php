...
<div class="row @if (request()->input('layout') == 'list') row-cols-1 shop-products-listing__list @else row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-2 @endif shop-products-listing g-0">
