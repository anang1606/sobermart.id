                    ...
                    <div class="tab-pane fade pt-4 show active" id="nav-login-content" role="tabpanel"
                        ...
                        <form class="mt-3" method="POST" action="{{ route('customer.login.post') }}">
                            ...
                            <div class="input-group mb-3 input-group-with-text">
                                ...
                                id="password" data-toggle="password" placeholder="{{ __('Password') }}" aria-label="{{ __('Password') }}" autocomplete="password">
                            ...
                            <div class="d-grid">
                            	<div style="width: 100%;">
                                    <div style="width: 100%;">
                                        ...
                                        <div style="margin-left: 50%; height: 50px;"> 
                                            <p class="text-right"><a href="{{ route('customer.password.reset') }}" class="d-inline-block text-primary">{{ __('Lupa Password?') }}</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
