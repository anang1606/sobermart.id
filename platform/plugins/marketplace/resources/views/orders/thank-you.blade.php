        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 right">
                @foreach ($orders as $order)
                    ...
                    @endif
                    @php
                        $total_payments += $order->payment->amount;
                    @endphp
                @endforeach
                ...
                @if (count($orders) > 1)
                    ...
                    <div class="bg-light p-3">
                        ...
                        <div class="row total-price">
                            ...
                            <div class="col-6">
                                <p class="total-text raw-total-text text-end"> {{ format_price($orders->sum('amount') - $total_payments) }}
                                </p>
                            </div>
                        </div>
                        <div class="row total-price">
                            ...
                            <div class="col-6">
                                <p class="total-text raw-total-text text-end"> {{ format_price($total_payments) }}
                                </p>
                            </div>
                        </div>
                    </div>
