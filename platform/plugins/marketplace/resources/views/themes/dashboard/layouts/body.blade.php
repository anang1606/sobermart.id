            ...
            <ul class="nav">
                ...
                <li class="dropdown nav-item">
                    <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount"
                        aria-expanded="false">
                        <img class="img-xs rounded-circle" src="{{ auth('customer')->user()->avatar_url }}"
                    ...
                    <div class="dropdown-menu dropdown-menu-end float-end" aria-labelledby="dropdownAccount">
                        <a class="dropdown-item" href="{{ route('customer.overview') }}"><i
                                class="material-icons md-perm_identity"></i>{{ __('My Account') }}</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-danger" href="{{ route('customer.logout') }}"><i
                                class="material-icons md-exit_to_app"></i>{{ __('Sign out') }}</a>
                    </div>
                </li>
            </ul>
        </div>
