                    ...
                    <div class="wrapper-content mb20">
                        ...
                        <div class="pd-all-10-20">
                            <form action="{{ route('marketplace.vendor.order-returns.edit', $returnRequest->id) }}" method="POST">
                                ...
                                @php
                                    $statusOptions = \Botble\Ecommerce\Enums\OrderReturnStatusEnum::labels();
                                    if (array_key_exists('completed', $statusOptions)) {
                                        unset($statusOptions['completed']);
                                    }
                                @endphp
                                {!! Form::customSelect('return_status', $statusOptions,$returnRequest->return_status, ['class'=> 'form-control']) !!}
