        ...
        if (is_plugin_active('ecommerce')) {
            ...
            Event::listen(RouteMatched::class, function () {
                dashboard_menu()
                    ...
                    ->registerItem([
                        'id' => 'cms-plugins-withdrawal-member',
                        'priority' => 6,
                        'parent_id' => 'cms-plugins-marketplace',
                        'name' => 'Withdrawal Member',
                        'icon' => null,
                        'url' => route('marketplace.member.withdrawal'),
                        'permissions' => ['marketplace.member.withdrawal'],
                    ])
                    ->registerItem([
                    ...
                    ->registerItem([
                        'id' => 'cms-plugins-ahli-waris',
                        'priority' => 4,
                        'parent_id' => 'cms-plugins-marketplace',
                        'name' => 'Ahli Waris',
                        'icon' => null,
                        'url' => route('marketplace.ahli-waris.index'),
                        'permissions' => ['marketplace.vendors.index'],
                    ])
                    ->registerItem([
                        'id' => 'cms-plugins-request-gift',
                        'priority' => 4,
                        'parent_id' => 'cms-plugins-marketplace',
                        'name' => 'Permintaan Hadiah',
                        'icon' => null,
                        'url' => route('marketplace.request-gift.index'),
                        'permissions' => ['marketplace.vendors.index'],
                    ])
                    ->registerItem([
                        'id' => 'paket-master',
                        ...
                        'name' => 'Paket Master',
                        'icon' => null,
                        'url' => route('marketplace.paket_master.index'),
                        'permissions' => ['marketplace.vendors.index'],
                    ])
                    ->registerItem([
                        'id' => 'support-message',
                        ...
                        'icon' => null,
                        'url' => route('marketplace.support-message.index'),
                        'permissions' => ['marketplace.vendors.index'],
                    ]);
