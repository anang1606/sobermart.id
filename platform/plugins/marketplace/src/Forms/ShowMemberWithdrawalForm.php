...
class ShowMemberWithdrawalForm extends FormAbstract
{
    public function buildForm(): void
    {
        ...
        $this
            ...
            // ->setFormOption('template', MarketplaceHelper::viewPath('dashboard.forms.base_member'))
            ->setFormOption('template', EcommerceHelper::viewPath('customers.member-list.base_member'))
            // ->setFormOption('template', Theme::scope(
            //     'dashboard.forms.base_member',
            //     [],
            //     'plugins/ecommerce::themes.customers.member-list.base_member'
            // ))
            ->withCustomFields()
            ->add('amount', 'number', [
