...
Route::group([
    ...
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::get(SlugHelper::getPrefix(Store::class, 'stores') . '/{slug}/{etalaseKey}', [
            'uses' => 'PublicStoreController@getStoreEtalase',
            'as' => 'public.store.etalase',
        ]);
        ...
        Route::group([
            ...
            Route::get('chats', [
                'as' => 'chats.index',
                'uses' => 'DashboardController@indexChats',
            ]);
            ...
            // Route::get('etalase', [
            //     'as' => 'etalase.index',
            //     'uses' => 'EtalaseController@index',
            // ]);


            Route::match(['GET', 'POST'], 'wilayah', [
                'as' => 'wilayah',
                'uses' => 'SettingController@getwilayah',
            ]);
            ...
            if (EcommerceHelper::isReviewEnabled()) {
                ...
                Route::post('reviews/reply', [
                        'as' => 'reviews.reply',
                        'uses' => 'ReviewController@replyReviews',
                    ]);
                Route::get('reviews/reply', [
                        'as' => 'reviews.reply',
                        'uses' => 'ReviewController@getReplyReviews',
                    ]);
            }
            ...
            Route::group(['prefix' => 'products', 'as' => 'products.'], function () {
                ...
                Route::match(['GET', 'POST'], 'kategori1', [
                    'as' => 'kategori1',
                    'uses' => 'ProductController@getKategori1',
                ]);

                Route::match(['GET', 'POST'], 'kategori2', [
                    'as' => 'kategori2',
                    'uses' => 'ProductController@getKategori2',
                ]);

                Route::match(['GET', 'POST'], 'kategori3', [
                    'as' => 'kategori3',
                    'uses' => 'ProductController@getKategori3',
                ]);

            });
            Route::match(['GET', 'POST'], 'etalase', [
                'as' => 'etalase.index',
                'uses' => 'EtalaseController@index',
            ]);

            Route::get('etalase/details', [
                'as' => 'etalase.details',
                'uses' => 'EtalaseController@etalaseDetails',
            ]);

            Route::post('etalase/delete/{id}', [
                'as' => 'etalase.destroy',
                'uses' => 'EtalaseController@destroy',
            ]);

            Route::post('etalase/update', [
                'as' => 'etalase.update',
                'uses' => 'EtalaseController@update',
            ]);

            Route::match(['GET', 'POST'],'revenueall', [
                'as' => 'revenueall.index',
                'uses' => 'OrderController@revenue',
            ]);
            // Route::get('revenueall', [
            //     'as' => 'revenueall.index',
            //     'uses' => 'OrderController@revenue',
            // ]);
            ...
            Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
                ...
                Route::get('generate-resi/{id}', [
                    'as' => 'generate-resi',
                    'uses' => 'OrderController@getGenerateResi',
                ]);
