                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="tanggal-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('neraca-lajur.view','tanggal') }}" method="post">
                                        @csrf
                                ...
                                <div class="tab-pane fade" id="bulan-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('neraca-lajur.view','bulan') }}" method="post">
                                        @csrf
                                        <div class="row form-group">
                                            <div class="col-12">
                                ...
                                <div class="tab-pane fade" id="tahun-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('neraca-lajur.view','tahun') }}" method="post">
                                        @csrf
                                        <div class="row form-group">
                                            <div class="col-12">
