                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="range-tab" data-bs-toggle="tab"
                                        data-bs-target="#range-tab-pane" type="button" role="tab"
                                        aria-controls="range-tab-pane" aria-selected="false">Rentang Waktu</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="tanggal-tab-pane" role="tabpanel"
                                    aria-labelledby="tanggal-tab" tabindex="0">
                                    <form action="{{ route('ongkos-kirim.view','tanggal') }}" method="post">
                                        @csrf
                                        <div class="row form-group">
                                            ...
                                            {{-- <div class="col-md-12 mt-3">
                                                <label for="a2">Kurir</label>
                                                <select name="kurir" id="a2" class="form-control" style="text-transform:uppercase">
                                ...
                                <div class="tab-pane fade" id="bulan-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('ongkos-kirim.view','bulan') }}" method="post">
                                        @csrf
                                        <div class="row form-group">
                                            <div class="col-12">
                                            ...
                                            {{-- <div class="col-12 mt-3">
                                                <label for="b3">Kurir</label>
                                                <select name="kurir" id="b3" class="form-control" style="text-transform:uppercase">
                                                    <option value="">-- Pilih Kurir --</option>
                                                    @foreach ($courier as $row)
                                                        <option value="{{ $row }}">
                                                            {{ $row }} </option>
                                ...
                                <div class="tab-pane fade" id="tahun-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('ongkos-kirim.view','tahun') }}" method="post">
                                        @csrf
                                        <div class="row form-group">
                                            <div class="col-12">
                                            ...
                                            {{-- <div class="col-12 mt-3">
                                                <label for="c2">Kurir</label>
                                                <select name="kurir" id="c2" class="form-control" style="text-transform:uppercase">
                                                    <option value="">-- Pilih Kurir --</option>
                                                    @foreach ($courier as $row)
                                                        <option value="{{ $row }}">
                                                            {{ $row }} </option>
                                ...
                                <div class="tab-pane fade" id="range-tab-pane" role="tabpanel"
                                    aria-labelledby="range-tab" tabindex="0">
                                    <form action="{{ route('ongkos-kirim.view','range') }}" method="post">
                                        @csrf
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                <label for="a1">Tanggal</label>
                                                <div class="input-group">
                                                    <input id="a1" type="date" name="date1" class="form-control"
                                                    value="{{ date('Y-m-d') }}">
                                                <input id="a2" type="date" name="date2" class="form-control"
                                                    value="{{ date('Y-m-d') }}">
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-12 mt-3">
