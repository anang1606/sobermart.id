    ...
    <section id="product-detail-page" class="content-page single-product-content">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                    ...
                    <div class="product-image-slider-thumbnails">
                        @foreach ($productImages as $thumb)
                            <div class="item">
                                <img src="{{ RvMedia::getImageUrl($thumb, 'product') }}" alt="{{ $product->name }}" />
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="product-page-content">
                        ...
                        <form class="single-variation-wrap">
                            ...
                            <div class="product-quantity">
                                ...
                                <input class="quantity input-lg" step="1" min="1" max="20"
                                    name="qty" value="1" title="Quantity" type="number" />
        ...
        <div class="product-tabs-wrapper container">
            <ul class="product-content-tabs nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="active" href="#tab_description" role="tab"
                        data-bs-toggle="tab">{{ __('Description') }}</a>
                </li>
                <li class="nav-item">
                ...
                @endif
                <li class="nav-item">
                    <a class="" href="#tab_more_products" role="tab"
                        data-bs-toggle="tab">{{ __('Related products') }}</a>
                </li>
            ...
            <div class="product-content-Tabs_wraper tab-content container">
                ...
                <div id="tab_additional_information" role="tabpanel" class="tab-pane fade">
                    <!-- Accordion Title -->
                    <h6 class="product-collapse-title" data-bs-toggle="collapse"
                        data-bs-target="#tab_additional_information-coll">{{ theme_option('product-bonus-title') }}
                    </h6>
                    <!-- End Accordion Title -->
                    <!-- Accordion Content -->
                ...
                @if (EcommerceHelper::isReviewEnabled())
                    <div id="tab_reviews" role="tabpanel" class="tab-pane fade">
                        <!-- Accordion Title -->
                        <h6 class="product-collapse-title" data-bs-toggle="collapse"
                            data-bs-target="#tab_reviews-coll">{{ __('Reviews') }}
