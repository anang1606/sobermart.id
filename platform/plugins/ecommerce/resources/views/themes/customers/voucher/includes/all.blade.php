    ...
    <div class="TMCf0u">
        @foreach ($vouchers as $voucher)
            ...
            @if ($voucher->type_option === 'shipping')
                ...
                @endphp
                @if ($voucher->store !== null)
                    @php
                        $className = 'vc_my-wallet-page-vouchers_sellerVoucher';
                    @endphp
                @endif
            ...
            <div class="LUGhvJ">
                <div class="d6WhVp">
                    <div class="vc_Card_container vc_my-wallet-page-vouchers_pc vc_my-wallet-page-vouchers_sellerVoucher {{ $className }}">
