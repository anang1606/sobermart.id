                        ...
                        <div class="profile-usermenu">
                            <ul class="list-group">
                                ...
                                @if (EcommerceHelper::isReviewEnabled())
                                    <li class="list-group-item">
                                        <a href="{{ route('customer.product-reviews') }}"
                                            class="collection-item @if (Route::currentRouteName() == 'customer.product-reviews') active @endif">{{ __('Product Reviews') }}</a>
                                ...
                                @if (EcommerceHelper::isEnabledSupportDigitalProducts())
                                    <li class="list-group-item">
                                        <a href="{{ route('customer.downloads') }}"
                                            class="collection-item @if (Route::currentRouteName() == 'customer.downloads') active @endif">{{ __('Downloads') }}</a>
                ...
                <form class="avatar-form" method="post" action="{{ route('customer.avatar') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="avatar-body">
                            ...
                            <div class="loading" tabindex="-1" role="img" aria-label="{{ __('Loading') }}">
                            </div>
