...
<div class="row price-group">
    ...
    <div class="col-md-12">
        <div class="form-group mb-3">
            ...
            <div class="next-input--stylized">            	
            	<select name="kategori1" id="kategori1" class="form-control @error('kategori1') is-invalid @enderror" required>
					<option value="{{ old('kategori1') ? old('kategori1') : $product->kategori1 ?? null}}" selected>
					{{ old('kategori1') ? old('kategori1') : $product->kategori1 ?? null}}
					</option>
				</select>                
				{!! Form::error('kategori1', $errors) !!}
                
                <select name="kategori2" id="kategori2" class="form-control @error('kategori2') is-invalid @enderror" required>					
                </select>
				{!! Form::error('kategori2', $errors) !!}
                
                <select name="kategori3" id="kategori3" class="form-control @error('kategori3') is-invalid @enderror" required>					
                </select>
				{!! Form::error('kategori3', $errors) !!}  
                
                <input name="kategoris" id="kategoris" readonly class="next-input"
                value="{{ old('kategori1', $product ? $product->kategori1 : $originalProduct->kategori1 ?? null) }} -> {{ old('kategori2', $product ? $product->kategori2 : $originalProduct->kategori2 ?? null) }} -> {{ old('kategori3', $product ? $product->kategori3 : $originalProduct->kategori3 ?? null) }}" type="text">                                  
    ...
    <div class="col-md-12">
        ...
        <input list="listetalase" name="etalase" id="etalase" value="{{ old('etalase', $product ? $product->etalase : $originalProduct->etalase ?? null) }}" 
    ...
    <div class="col-md-4">
        <div class="form-group mb-3">
            ...
            <div class="next-input--stylized">
				...
				<input name="hpp" id="hpp" onkeyup="findTotal()" class="next-input input-mask-number regular-price next-input--invisible harga-input"
                ...
                value="{{ old('hpp', $product ? $product->hpp : $originalProduct->hpp ?? 0) }}" type="text" style="color:#999999">
        	</div>    
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-3">
            ...
            <div class="next-input--stylized">
                <span class="next-input-add-on next-input__add-on--before">{{ get_application_currency()->symbol }}</span>
				<input name="fee" id="fee" readonly class="next-input input-mask-number regular-price next-input--invisible"
                data-thousands-separator="{{ EcommerceHelper::getThousandSeparatorForInputMask() }}"
                data-decimal-separator="{{ EcommerceHelper::getDecimalSeparatorForInputMask() }}" step="any"
                value="{{ old('fee', $product ? $product->fee : $originalProduct->fee ?? 0) }}" type="text" style="color:#999999">
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group mb-3">
            ...
            <div class="next-input--stylized">
                <span class="next-input-add-on next-input__add-on--before">{{ get_application_currency()->symbol }}</span>
				<input name="price" id="price" readonly class="next-input input-mask-number regular-price next-input--invisible"
                data-thousands-separator="{{ EcommerceHelper::getThousandSeparatorForInputMask() }}"
                data-decimal-separator="{{ EcommerceHelper::getDecimalSeparatorForInputMask() }}" step="any"
                value="{{ old('price', $product ? $product->price : $originalProduct->price ?? 0) }}" type="text" style="color:#999999">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="form-group mb-3">
                ...
                <div class="next-input--stylized">
                    ...
                    <input name="sale_price" class="next-input input-mask-number sale-price next-input--invisible harga-input"
                        data-thousands-separator="{{ EcommerceHelper::getThousandSeparatorForInputMask() }}"
        ...
        <div class="col-md-4">
            <div class="form-group mb-3">
                ...
                <div class="next-input--stylized">
                    <span
                        class="next-input-add-on next-input__add-on--before">{{ get_application_currency()->symbol }}</span>
                    <input name="cost_per_item" class="next-input input-mask-number regular-price next-input--invisible"
                        step="any"
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="next-input--stylized">
                        ...
                        <input type="text" class="next-input input-mask-number next-input--invisible harga-input"
                            name="weight"
                            value="{{ old('weight', $product ? $product->weight : $originalProduct->weight ?? 0) }}"  style="color:#999999">
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-md-6">
                <div class="form-group mb-3">
                    ...
                    <div class="next-input--stylized">
                        ...
                        <input type="text" class="next-input input-mask-number next-input--invisible harga-input"
                            name="length"
                            value="{{ old('length', $product ? $product->length : $originalProduct->length ?? 0) }}"  style="color:#999999">
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-md-6">
                <div class="form-group mb-3">
                    ...
                    <div class="next-input--stylized">
                        ...
                        <input type="text" class="next-input input-mask-number next-input--invisible harga-input"
                            name="wide"
                            value="{{ old('wide', $product ? $product->wide : $originalProduct->wide ?? 0) }}"  style="color:#999999">
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-md-6">
                <div class="form-group mb-3">
                    ...
                    <div class="next-input--stylized">
                        ...
                        <input type="text" class="next-input input-mask-number next-input--invisible harga-input"
                            name="height"
                            value="{{ old('height', $product ? $product->height : $originalProduct->height ?? 0) }}"  style="color:#999999">
                    </div>
                </div>
            </div>
        </div>
			...
			success: function(response) {
				...
				if (myData.status == 'OK') 
				{
					if (document.title == 'New product')
					{
						...
						document.getElementById('kategori1').innerHTML = `<option value='' selected disabled>--Silahkan Pilih--</option>`
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (myData.status == 'OK') 
					{
						...
						document.getElementById('kategori2').innerHTML = `<option value='' selected disabled>--Silahkan Pilih--</option>`
						jQuery.each(kategorilist, function(index, value){
							document.getElementById('kategori2').innerHTML +=
							"<option data-id="+ value.id +" value="+ value.id +">"+ value.name +"</option>"
						})
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (myData.status == 'OK') 
					{
						...
						document.getElementById('kategori3').innerHTML = `<option value='' selected disabled>--Silahkan Pilih--</option>`
						jQuery.each(kategorilist, function(index, value){
							document.getElementById('kategori3').innerHTML +=
							"<option data-id="+ value.id +" value="+ value.id +">"+ value.name +"</option>"
						})
