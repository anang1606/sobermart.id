<div class="pt-3 mb-4">
    ...
    <div class="checkout-success-products">
        <div class="row show-cart-row d-md-none p-2">
            <div class="col-9">
                <a class="show-cart-link" href="javascript:void(0);" data-bs-toggle="collapse"
                    data-bs-target="{{ '#cart-item-' . $order->id }}">
                    {{ __('Order information :order_id', ['order_id' => $order->code]) }} <i class="fa fa-angle-down"
                        aria-hidden="true"></i>
                </a>
            </div>
            <div class="col-3">
            ...
            @foreach ($order->products as $orderProduct)
                @php
                    $product = get_products([
                        ...
                        'take' => 1,
                        'select' => ['ec_products.id', 'ec_products.image', 'ec_products.images', 'ec_products.name', 'ec_products.price', 'ec_products.sale_price', 'ec_products.sale_type', 'ec_products.start_date', 'ec_products.end_date', 'ec_products.sku', 'ec_products.is_variation', 'ec_products.status', 'ec_products.order', 'ec_products.created_at'],
                    ]);
                @endphp
