    ...
    @include('plugins/ecommerce::orders.thank-you.total-row', [
        'label' =>
            ...
            ($order->is_free_shipping
                ...
                : ''),
        'value' => $order->shipping_service . ' - ' . format_price($order->shipping_amount),
    ])
@endif
...
<div class="row">
    ...
    <div class="col-6 float-end">
        <p class="total-text raw-total-text"> {{ format_price($order->amount - $order->payment->amount) }} </p>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-6 float-end">
        <p class="total-text raw-total-text"> {{ format_price($order->payment->amount) }} </p>
    </div>
</div>
