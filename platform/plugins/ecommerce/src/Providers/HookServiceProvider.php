...
use Botble\Payment\Services\Gateways\MidtransPaymentService;
            ...
            add_filter(FILTER_ECOMMERCE_PROCESS_PAYMENT, function (array $data, Request $request) {
                ...
                switch ($request->input('payment_method')) {
                    ...
                    case PaymentMethodEnum::BANK_TRANSFER:
                        $data['charge_id'] = $this->app->make(MidtransPaymentService::class)->execute($paymentData,PaymentMethodEnum::BANK_TRANSFER);
                        break;
                    case PaymentMethodEnum::QRIS:
                        $data['charge_id'] = $this->app->make(MidtransPaymentService::class)->execute($paymentData,PaymentMethodEnum::QRIS);
                        break;
                    case PaymentMethodEnum::CSTORE:
                        $data['charge_id'] = $this->app->make(MidtransPaymentService::class)->execute($paymentData,PaymentMethodEnum::CSTORE);
                        break;
                    case PaymentMethodEnum::CREDIT_CARD:
                        $data['charge_id'] = $this->app->make(MidtransPaymentService::class)->execute($paymentData,PaymentMethodEnum::CREDIT_CARD);
                        break;
                    default:
        ...
        if (defined('PAYMENT_FILTER_PAYMENT_DATA')) {
            add_filter(PAYMENT_FILTER_PAYMENT_DATA, function (array $data, Request $request) {
                ...
                return [
                    ...
                    'payment_id' => $request->input('payment_order_id'),
