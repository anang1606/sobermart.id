...
class NewCustomerCard extends Card
{
    ...
    {
        $data = MemberPaket::whereDate('created_at', '>=', $this->startDate)
    ...
    {
        $count = MemberPaket::whereDate('created_at', '>=', $this->startDate)
            ->whereDate('created_at', '<=', $this->endDate)
            ->count();
        ...
        $currentCustomers = MemberPaket::whereDate('created_at', '>=', $currentPeriod->getStartDate())
            ->whereDate('created_at', '<=', $currentPeriod->getEndDate())
            ->count();

        $previousCustomers = MemberPaket::whereDate('created_at', '>=', $previousPeriod->getStartDate())
