...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::get('broadcast/create', [
            'as' => 'ecommerce.broadcast.create',
            'uses' => 'BroadcastController@create',
            'permission' => 'ecommerce.settings',
        ]);

        Route::post('broadcast/create', [
            'as' => 'ecommerce.broadcast.create',
            'uses' => 'BroadcastController@store',
            'permission' => 'ecommerce.settings',
        ]);

        Route::get('broadcast/all/customer', [
            'as' => 'ecommerce.broadcast.all.cutomer',
            'uses' => 'BroadcastController@getAllCustomer',
            'permission' => 'ecommerce.settings',
        ]);

        Route::get('broadcast/get-relations-boxes', [
            'as' => 'ecommerce.broadcast.get-relations-boxes',
            'uses' => 'BroadcastController@getRelationsBoxes',
            'permission' => 'ecommerce.settings',
        ]);

        Route::get('broadcast/edit/{id}', [
            'as' => 'ecommerce.broadcast.edit',
            'uses' => 'BroadcastController@edit',
            'permission' => 'ecommerce.settings',
        ]);

        Route::delete('broadcast/delete/{id}', [
            'as' => 'ecommerce.broadcast.destroy',
