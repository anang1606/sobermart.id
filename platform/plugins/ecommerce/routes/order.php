...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::group(['prefix' => 'checkout/', 'as' => 'public.checkout.'], function () {
            ...
            Route::get('beli-langsung', [
                'as' => 'beli-langsung',
                'uses' => 'PublicCheckoutController@beliLangsung',
            ]);

            Route::get('beli-langsung/shipment', [
                'uses' => 'PublicCheckoutController@getShipmentPrice',
            ]);
            ...
            Route::post('voucher', [
                'as' => 'voucher',
                'uses' => 'PublicCheckoutController@getVoucherPrice',
            ]);

            Route::get('reset-voucher', [
                'as' => 'reset-voucher',
                'uses' => 'PublicCheckoutController@resetVoucher',
            ]);

            Route::post('voucher-submit', [
                'as' => 'voucher-submit',
                'uses' => 'PublicCheckoutController@setVoucher',
            ]);
            ...
            Route::post('payments', [
                'as' => 'midtrans',
                'uses' => 'PublicCheckoutController@postCheckoutData',
            ]);
